...
function App() {
  ...
  const handleLogin = (userData) => {
    setIsLoggedIn(true);
    setUser(userData); // Store user data if needed
  };
  ...
  // Example featured brands data
  const featuredBrands = [
    { id: 1, name: 'Brand A', image: '/images/brands/brandA.jpg' },
    { id: 2, name: 'Brand B', image: '/images/brands/brandB.jpg' },
